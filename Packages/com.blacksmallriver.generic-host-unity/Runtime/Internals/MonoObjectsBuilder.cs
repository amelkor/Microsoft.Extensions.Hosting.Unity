...
{
    /// <inheritdoc/>
    [Obsolete("Use " + nameof(UnityCollectionBuilder) + " instead", true)]
    internal class MonoObjectsBuilder : IMonoObjectsBuilder
    {
        private readonly IHostBuilder _hostBuilder;
        private readonly string _serviceInjectionMethodName;
        private IServiceCollection _services;

        public MonoObjectsBuilder(IHostBuilder hostBuilder, string serviceInjectionMethodName)
        {
        ...
        /// <inheritdoc/>
        public IMonoObjectsBuilder AddMonoBehaviourSingleton<T, TImpl>(TImpl component, bool useHostLifetime = false) where TImpl : MonoBehaviour, T where T : class
        {
            if (!component)
                throw new ArgumentNullException(nameof(component), "Component is missing");
